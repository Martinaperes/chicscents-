<x-admin-layout>
    ...
    <div class="mb-6">
        <a href="{{ route('bot-questions.index') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 transition">
    ...
    <div class="bg-white rounded-lg shadow-lg border border-gray-200 p-8">
        <div class="mb-6">
            <h2 class="text-2xl font-bold text-gray-900 mb-2">Import Questions from JSON</h2>
            <p class="text-gray-600">Import multiple bot questions at once using a JSON file or by pasting JSON content.</p>
        </div>

        @if(session('import_errors'))
            <div class="mb-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <h3 class="text-sm font-semibold text-yellow-800 mb-2">Import Errors:</h3>
        ...
        <form action="{{ route('bot-questions.import.process') }}" method="POST" enctype="multipart/form-data" id="import-form">
            ...
            <div class="mb-6">
                ...
                <div class="flex gap-6">
                    <label class="flex items-center cursor-pointer">
                        ...
                        <span class="text-gray-700 font-medium">Upload JSON File</span>
                    </label>
                    <label class="flex items-center cursor-pointer">
                        ...
                        <span class="text-gray-700 font-medium">Paste JSON Content</span>
                    </label>
                </div>
            </div>
            ...
            <div id="file-upload-section" class="mb-6">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-500 transition">
                    ...
                    <label for="json_file" class="cursor-pointer">
                        ...
                        <p class="text-xs text-gray-500">JSON or TXT file (MAX. 10MB)</p>
                    </label>
                    <p id="file-name" class="mt-2 text-sm text-gray-700 font-medium hidden"></p>
                </div>
                @if(isset($errors) && $errors->has('json_file'))
                    <p class="mt-2 text-sm text-red-600">{{ $errors->first('json_file') }}</p>
                @endif
            </div>
            ...
            <div id="paste-json-section" class="mb-6 hidden">
                ...
                <textarea name="json_content" id="json_content" rows="15" 
                          class="w-full rounded-lg border-gray-300 font-mono text-sm p-4 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                          placeholder='Paste your JSON array here...&#10;&#10;Example:&#10;[&#10;  {&#10;    "question": "What is your name?",&#10;    "keywords": ["name", "who"],&#10;    "logic_operator": "OR",&#10;    "answer": "My name is Bot.",&#10;    "priority": 0,&#10;    "is_active": true&#10;  }&#10;]'></textarea>
                @if(isset($errors) && $errors->has('json_content'))
                    <p class="mt-2 text-sm text-red-600">{{ $errors->first('json_content') }}</p>
                @endif
            </div>
      ...
      "user.role": {
        "==": "premium"
                ...
                <div class="border-t border-blue-200 pt-4">
                    <h4 class="text-sm font-semibold text-blue-900 mb-2">Field Descriptions:</h4>
            ...
            <div class="mb-6 bg-purple-50 border border-purple-200 rounded-lg p-6">
                ...
                <div class="bg-white rounded p-4 mb-3">
                    ...
                    <div class="bg-gray-100 rounded p-3 font-mono text-xs text-gray-800" id="ai-prompt">
